...
type Goods struct {
	...
	PictureUrl  string    `gorm:"column:picture_url;type:varchar(2048)" redis:"picture_url"`
	Description string    `gorm:"column:description;type:varchar(2048)" redis:"description"`
